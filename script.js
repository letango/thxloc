...
async function initializeMapPlannersWithNewFeatures() {
  try {
    const [esriConfig, Map, MapView, CSVLayer, FeatureReductionCluster, clusters, AggregateField, ExpressionInfo] = await Promise.all([
    ...
    const csvLayer = new CSVLayer({
      url: "https://raw.githubusercontent.com/letango/thxloc/blob/main/final%20xy%20coordinates.csv",
      copyright: "data",
      renderer: {
        type: "simple",
        symbol: {
